      ...
      <div className={css.container}>
        ...
        <div className={css.content}>
          <div className={css.hero}>
            <h1>Hi! My name is yasmeen</h1>
            <img src="image.jpg" alt="profileimg" />
            <div className={css.herocontent}>
              <h2 className="css.h2">A little about me</h2>
              <p className="css.p">
                I am a Frontend Developer. My passion drives me to the field of
                web development technology. Also i love to share my knowledge
                with others.
              </p>
            </div>
          </div>
